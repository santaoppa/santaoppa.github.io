...
Spring Boot는 기본적으로 `src/main/resources/templates` 디렉토리를 템플릿 파일의 기본 경로로 인식하며,
타임리프는 해당 경로에서 동작할 수 있도록 자동 설정됨
...
결론적으로, Spring Boot 기반 애플리케이션에서는 JSP보다 타임리프를 사용하는 것이 구조적으로 더 적합하며, 빌드, 배포, 유지보수 측면에서도 효율적임!